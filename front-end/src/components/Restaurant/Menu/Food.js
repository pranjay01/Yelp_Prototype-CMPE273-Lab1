      ...
      >
        <div data-ui="group">
          <form
            ...
            id="signup-form"
          >
            <fieldset disabled={this.props.food._id !== this.props.editableId && 'disabled'}>
              <div className="js-password-meter-container">
                <ul className="inline-layout clearfix">
                  ...
                  <li style={{ width: '38%' }}>
                    ...
                    <input
                      ...
                      type="text"
                      onChange={(event, id) =>
                        this.props.onNameChangeHandler(event.target.value, this.props.food._id)
                      }
                  ...
                  <li style={{ width: '22%' }}>
                    ...
                    <input
                      ...
                      step="0.01"
                      onChange={(event, id) =>
                        this.props.onPriceChangeHandler(event.target.value, this.props.food._id)
                      }
                ...
                <ul className="inline-layout clearfix">
                  ...
                  <li style={{ width: '22%' }}>
                    ...
                    <select
                      ...
                      onChange={(event, id) =>
                        this.props.onCusineChangeHandler(event.target.value, this.props.food._id)
                      }
                      value={this.props.food.Cuisine}
                      required
                    >
                  ...
                  <li style={{ width: '40%' }}>
                    ...
                    <input
                      ...
                      type="text"
                      onChange={(event, id) =>
                        this.props.onIngredentsChangeHandler(
                          event.target.value,
                          this.props.food._id
                        )
                      }
                ...
                {this.props.food._id === this.props.editableId && (
                  <ul>
          ...
          {this.props.food._id !== this.props.editableId && (
            <div className="job-form-section-group-viewer-styles__dotsWrapper--Jt82u">
              <span aria-hidden="true" className="icon--24-deal-v2 css-1mpk29p">
                <a
                  href="#"
                  onClick={() => this.props.makeEditable(this.props.food._id)}
                  style={{ cursor: 'pointer' }}
                >
                  <svg
              ...
              <span aria-hidden="true" className="icon--24-deal-v2 css-1mpk29p">
                <a
                  href="#"
                  onClick={(event) => this.props.onDelete(event, this.props.food._id)}
                  style={{ cursor: 'pointer' }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          {this.props.food._id === this.props.editableId && (
            <div>
              <div className="job-form-section-group-viewer-styles__dotsWrapper--Jt82u">
                <span aria-hidden="true" className="icon--24-deal-v2 css-1mpk29p"></span>
                <span aria-hidden="true" className="icon--24-deal-v2 css-1mpk29p">
                  <a href="#" onClick={this.props.onCancelUpdate} style={{ cursor: 'pointer' }}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
