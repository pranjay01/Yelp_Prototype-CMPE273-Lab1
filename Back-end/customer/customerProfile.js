...
let checkEmailExists = async (email) => {
  ...
  let [results, fields] = await connection.query(verifyEmailExist, [email, 1]);
...
let signup = async (customer, response) => {
  let { Email, Password, First_Name, Last_Name, Gender } = customer;
